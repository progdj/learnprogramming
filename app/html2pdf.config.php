...
define('DEFAULT_ENCODING', 'windows-1252');
...
define('GS_PATH', PdfCreator::getGhostcriptPath(TRUE));

// Path to font metric files (AFM files). 
// NOTE: Trailing backslash required
define('TYPE1_FONTS_REPOSITORY', PdfCreator::getAbsoluteFontsPath(TRUE));
...
//dl(HTML2PS_DIR.'pdflib\libpdf_php.dll');
//define('PDFLIB_DL_PATH', 'php_pdf.dll');//original: pdflib_php.dll
//echo phpversion();

// Uncomment this if you have PDFLIB license key and want to use it
define('PDFLIB_LICENSE', 'L900102-010032-800406-BJHC32-YZ5F82');
...
define('TTF_FONTS_REPOSITORY', PdfCreator::getAbsoluteFontsPath(TRUE));
